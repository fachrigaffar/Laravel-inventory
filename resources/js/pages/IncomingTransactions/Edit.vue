...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Incoming Transactions Edit',
...
<template>
    <Head title="Incoming Transactions Edit" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="overflow-x-auto shadow-md sm:rounded-lg my-5 mx-5">
            ...
            <form @submit.prevent="form.put(route('incoming-transactions.update', transaction.id))" class="space-y-4 mx-5 my-5">
                <div>
