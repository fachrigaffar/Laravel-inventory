...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Outgoing Transactions Create',
...
<template>
    <Head title="Outgoing Transactions Create" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="overflow-x-auto shadow-md sm:rounded-lg my-5 mx-5">
            ...
            <form @submit.prevent="form.post(route('outgoing-transactions.store'))" class="space-y-4 mx-5 my-5">
                <div>
